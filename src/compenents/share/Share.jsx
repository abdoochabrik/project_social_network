              ...
              <div className="shareButtom">
                  <div className="shareOptions">
                      <div className="shareOption">
                            ...
                            <span className="shareOptionText" type="file" >Photo or Video</span>
                            <input onChange = {handleImageChange} type="file" name="picture"   />
                      </div>
                      <div className="shareOption">
